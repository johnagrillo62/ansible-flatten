(playbook "debops/ansible/roles/libvirtd_qemu/defaults/main.yml"
  (libvirtd_qemu__kvm_support (jinja "{{ True
                                if (ansible_virtualization_type == \"kvm\" and
                                    (ansible_virtualization_role == \"host\" or
                                     libvirtd_qemu__register_hw_virt.stdout | d()))
                                else False }}"))
  (libvirtd_qemu__base_packages (list
  ...
  (libvirtd_qemu__base_packages_map 
    ...
    (xenial (list
        "libvirt-bin")))
  (libvirtd_qemu__kvm_packages (jinja "{{ [\"qemu-system-x86\", \"qemu-utils\"]
                                 + [\"qemu-kvm\"]
                                   if ansible_distribution_release in
                                        [\"stretch\", \"buster\", \"bionic\", \"focal\"]
                                   else [] }}"))
  (libvirtd_qemu__packages (list))
  (libvirtd_qemu__deployment_mode (jinja "{{ ansible_local.libvirtd.deployment_mode
                                    if (ansible_local.libvirtd.deployment_mode | d())
                                    else (\"opennebula\"
                                          if (\"debops_service_opennebula_node\" in group_names)
                                          else \"libvirt\") }}"))
  (libvirtd_qemu__user (jinja "{{ (ansible_local.opennebula.user
                          if (ansible_local.opennebula.user | d())
                          else \"oneadmin\")
                         if (libvirtd_qemu__deployment_mode == \"opennebula\")
                         else \"libvirt-qemu\" }}"))
  (libvirtd_qemu__group (jinja "{{ (ansible_local.opennebula.group
                           if (ansible_local.opennebula.group | d())
                           else \"oneadmin\")
                          if (libvirtd_qemu__deployment_mode == \"opennebula\")
                          else \"libvirt-qemu\" }}"))
  (libvirtd_qemu__remote_display_allow (list))
  (libvirtd_qemu__remote_display_ports (jinja "{{ libvirtd_qemu__remote_display_port_min | string + \":\"
  ...
  (libvirtd_qemu__spice_listen (jinja "{{ \"0.0.0.0\"
                                 if libvirtd_qemu__remote_display_allow | d()
                                 else \"127.0.0.1\" }}"))
  (libvirtd_qemu__vnc_listen (jinja "{{ \"0.0.0.0\"
                               if libvirtd_qemu__remote_display_allow | d()
                               else \"127.0.0.1\" }}"))
  (libvirtd_qemu__original_configuration (list
      
      (name "default_tls_x509_cert_dir")
      (comment "Use of TLS requires that x509 certificates be issued. The default is
...
")
      ...
      (comment "Libvirt assumes the server-key.pem file is unencrypted by default.
...
")
      ...
      (comment "Enable this option to have VNC served over an automatically created
...
")
      ...
      (comment "In order to override the default TLS certificate location for
...
")
      ...
      (name "vnc_password")
      (comment "The default VNC password. Only 8 bytes are significant for
...
")
      ...
      (comment "QEMU implements an extension for providing audio over a VNC connection,
...
")
      ...
      (name "spice_listen")
      (comment "SPICE is configured to listen on 127.0.0.1 by default.
To make it listen on all public interfaces, uncomment
this next option.
...
")
      ...
      (name "spice_tls")
      (comment "Enable use of TLS encryption on the SPICE server.
...
")
      ...
      (comment "Enable this option to have SPICE served over an automatically created
unix socket. This prevents unprivileged access from users on the
host machine.
...
")
      ...
      (name "spice_password")
      (comment "The default SPICE password. This parameter is only used if the
...
")
      ...
      (name "spice_sasl")
      (comment "Enable use of SASL encryption on the SPICE server. This requires
...
")
      ...
      (name "chardev_tls")
      (comment "Enable use of TLS encryption on the chardev TCP transports.
...
")
      ...
      (comment "In order to override the default TLS certificate location for character
...
")
      ...
      (comment "Uncomment and use the following option to override the default secret
...
")
      ...
      (comment "By default, if no graphical front end is configured, libvirt will disable
...
")
      ...
      (comment "Override the port for creating both VNC and SPICE sessions (min).
...
")
      ...
      (comment "VNC WebSocket port policies, same rules apply as with remote display
...
")
      ...
      (comment "The default security driver is SELinux. If SELinux is disabled
...
")
      ...
      (comment "If set to non-zero, then the default security labeling
...
")
      ...
      (comment "If set to non-zero, then attempts to create unconfined
...
")
      ...
      (name "user")
      (comment "The user for QEMU processes run by the system instance. It can be
...
")
      ...
      (name "group")
      (comment "The group for QEMU processes run by the system instance. It can be
...
")
      ...
      (comment "Whether libvirt should dynamically change file ownership
...
")
      ...
      (comment "What cgroup controllers to make use of with QEMU guests
...
")
      ...
      (comment "This is the basic set of devices allowed / required by
...
")
      ...
      (comment "The default format for Qemu/KVM guest save images is raw; that is, the
...
")
      ...
      (name "auto_dump_path")
      (comment "When a domain is configured to be auto-dumped when libvirtd receives a
...
")
      ...
      (comment "When a domain is configured to be auto-dumped, enabling this flag
...
")
      ...
      (comment "When a domain is configured to be auto-started, enabling this flag
...
")
      ...
      (comment "If provided by the host and a hugetlbfs mount point is configured,
...
")
      ...
      (name "bridge_helper")
      (comment "Path to the setuid helper for creating tap devices.  This executable
...
")
      ...
      (comment "If clear_emulator_capabilities is enabled, libvirt will drop all
...
")
      ...
      (comment "If enabled, libvirt will have QEMU set its process name to
...
")
      ...
      (name "max_processes")
      (comment "If max_processes is set to a positive integer, libvirt will use
...
")
      ...
      (name "max_core")
      (comment "If max_core is set to a non-zero integer, then QEMU will be
...
")
      ...
      (comment "Determine if guest RAM is included in QEMU core dumps. By
...
")
      ...
      (name "mac_filter")
      (comment "mac_filter enables MAC addressed based filtering on bridge ports.
...
")
      ...
      (comment "By default, PCI devices below non-ACS switch are not allowed to be assigned
...
")
      ...
      (comment "If allow_disk_format_probing is enabled, libvirt will probe disk
...
")
      ...
      (name "lock_manager")
      (comment "In order to prevent accidentally starting two domains that
...
")
      ...
      (name "max_queued")
      (comment "Set limit of maximum APIs queued on one domain. All other APIs
...
")
      ...
      (comment "This allows qemu driver to detect broken connections to remote
...
")
      ...
      (comment "Use seccomp syscall whitelisting in QEMU.
...
")
      ...
      (comment "Override the listen address for all incoming migrations. Defaults to
...
")
      ...
      (name "migration_host")
      (comment "The default hostname or IP address which will be used by a migration
...
")
      ...
      (comment "Override the port range used for incoming migrations.
...
")
      ...
      (name "log_timestamp")
      (comment "Timestamp QEMU log messages (if QEMU supports it)
...
")
      ...
      (name "nvram")
      (comment "Location of master nvram file
...
")
      ...
      (name "stdio_handler")
      (comment "The backend to use for handling stdout/stderr output from
QEMU processes.
...
")
      ...
      (comment "QEMU gluster libgfapi log level, debug levels are 0-9, with 9 being the
...
")
      ...
      (name "namespaces")
      (comment "To enhance security, QEMU driver is capable of creating private namespaces
...
")
      ...
      (state "comment")
      (weight "1")))
  (libvirtd_qemu__default_configuration (list
      
      (name "spice_listen")
      (value (jinja "{{ libvirtd_qemu__spice_listen }}"))
      (state (jinja "{{ \"present\"
               if (libvirtd_qemu__remote_display_allow | d())
               else \"ignore\" }}"))
      
      (name "vnc_listen")
      (value (jinja "{{ libvirtd_qemu__vnc_listen }}"))
      (state (jinja "{{ \"present\"
               if (libvirtd_qemu__remote_display_allow | d())
               else \"ignore\" }}"))
      
      (name "remote_display_port_min")
      (value (jinja "{{ libvirtd_qemu__remote_display_port_min }}"))
      (state (jinja "{{ \"present\"
               if (libvirtd_qemu__deployment_mode == \"opennebula\")
               else \"ignore\" }}"))
      
      (name "remote_display_port_max")
      (value (jinja "{{ libvirtd_qemu__remote_display_port_max }}"))
      (state (jinja "{{ \"present\"
               if (libvirtd_qemu__deployment_mode == \"opennebula\")
               else \"ignore\" }}"))
      
      (name "user")
      (value (jinja "{{ libvirtd_qemu__user }}"))
      (state (jinja "{{ \"present\"
               if (libvirtd_qemu__deployment_mode == \"opennebula\")
               else \"ignore\" }}"))
      
      (name "group")
      (value (jinja "{{ libvirtd_qemu__group }}"))
      (state (jinja "{{ \"present\"
               if (libvirtd_qemu__deployment_mode == \"opennebula\")
               else \"ignore\" }}"))
  ...
  (libvirtd_qemu__configuration (list))
  (libvirtd_qemu__group_configuration (list))
  (libvirtd_qemu__host_configuration (list))
  (libvirtd_qemu__combined_configuration (jinja "{{ libvirtd_qemu__original_configuration
  ...
  (libvirtd_qemu__configuration_sections (list
  ...
  (libvirtd_qemu__ferm__dependent_rules (list
      
      (name "libvirtd_qemu__remote_display")
      (type "accept")
      (dport (jinja "{{ libvirtd_qemu__remote_display_ports }}"))
      (saddr (jinja "{{ libvirtd_qemu__remote_display_allow }}"))
      (accept_any "False")
