(playbook "debops/ansible/roles/postwhite/handlers/main.yml"
  (tasks
    (task "Update Postwhite in the background using async"
    ...
    (task "Update Postwhite in the background using batch"
