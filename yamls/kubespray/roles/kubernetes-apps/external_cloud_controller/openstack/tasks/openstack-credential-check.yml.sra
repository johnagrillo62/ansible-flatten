(playbook "kubespray/roles/kubernetes-apps/external_cloud_controller/openstack/tasks/openstack-credential-check.yml"
  (tasks
    (task "External OpenStack Cloud Controller | check external_openstack_auth_url value"
      (fail 
    ...
    (task "External OpenStack Cloud Controller | check external_openstack_username or external_openstack_application_credential_name value"
      (fail 
    ...
    (task "External OpenStack Cloud Controller | check external_openstack_application_credential_id value"
      (fail 
    ...
    (task "External OpenStack Cloud Controller | check external_openstack_application_credential_secret value"
      (fail 
    ...
    (task "External OpenStack Cloud Controller | check external_openstack_password value"
      (fail 
    ...
    (task "External OpenStack Cloud Controller | check external_openstack_region value"
      (fail 
        (msg "external_openstack_region is missing"))
      (when "external_openstack_region is not defined or not external_openstack_region"))
    (task "External OpenStack Cloud Controller | check external_openstack_tenant_id value"
      (fail 
      ...
      (when (list
          ...
          "external_openstack_application_credential_name is not defined or not external_openstack_application_credential_name")))
    (task "External OpenStack Cloud Controller | check external_openstack_domain_id value"
      (fail 
