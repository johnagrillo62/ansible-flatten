(playbook "kubespray/roles/kubernetes-apps/csi_driver/vsphere/tasks/vsphere-credentials-check.yml"
  (tasks
    ...
    (task "External vSphere Cloud Provider | check external_vsphere_kubernetes_cluster_id value"
      (fail 
