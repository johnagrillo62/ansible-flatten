(playbook "kubespray/roles/kubernetes-apps/container_engine_accelerator/nvidia_gpu/defaults/main.yml"
  ...
  (nvidia_url_end (jinja "{{ nvidia_driver_version }}") "/NVIDIA-Linux-x86_64-" (jinja "{{ nvidia_driver_version }}") ".run")
