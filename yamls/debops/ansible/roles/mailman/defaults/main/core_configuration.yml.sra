(playbook "debops/ansible/roles/mailman/defaults/main/core_configuration.yml"
  (mailman__core_original_configuration (list
      
      (name "mailman")
      (options (list
          
          (name "site_owner")
          (comment "This address is the \"site owner\" address.  Certain messages which must be
...
")
          ...
          (comment "This is the local-part of an email address used in the From field whenever a
...
")
          ...
          (name "sender_headers")
          (comment "Membership tests for posting purposes are usually performed by looking at a
...
")
          ...
          (comment "Default length of time a pending request is live before it is evicted from
...
")
          ...
          (name "pre_hook")
          (comment "A callable to run with no arguments early in the initialization process.
This runs before database initialization.
")
          (value "")
          
          (name "post_hook")
          (comment "A callable to run with no arguments late in the initialization process.
This runs after adapters are initialized.
")
          (value "")
          
          (name "layout")
          (comment "Which paths.* file system layout to use.
...
")
          ...
          (comment "How should text/html parts be converted to text/plain when the mailing list
...
")
          ...
          (name "listname_chars")
          (comment "Specify what characters are allowed in list names.  Characters outside of
...
")
      ...
      (name "shell")
      (separator "True")
      (comment "`mailman shell` (also `withlist`) gives you an interactive prompt that you
...
")
      (options (list
          ...
          (name "use_ipython")
          (comment "Use IPython as the shell, which must be found on the system.  Valid values
...
")
          ...
          (name "history_file")
          (comment "Set this to allow for command line history if readline is available.  This
...
")
      ...
      (name "paths.debian")
      (separator "True")
      (comment "Important directories for Mailman operation.  These are defined here so that
...
")
      (options (list
          ...
          (name "var_dir")
          (comment "This is the root of the directory structure that Mailman will use to store
its run-time data.
")
          ...
          (name "bin_dir")
          (comment "This is the directory containing the Mailman 'runner' and 'master' commands
...
")
          ...
          (name "archive_dir")
          (comment "Directory for archive backends to store their messages in.  Archivers should
...
")
          ...
          (name "pid_file")
          (comment "There are also a number of paths to specific file locations that can be
...
")
      ...
      (options (list
          ...
          (name "url_sqlite")
          (option "url")
          (comment "Use this to set the Storm database engine URL.  You generally have one
...
")
      ...
      (name "logging.debian")
      (separator "True")
      (comment "This defines various log settings.  The options available are:
...
")
      ...
      (options (list
          ...
          (comment "Whether or not to show tracebacks in an HTTP response for a request that
raised an exception.
")
          (value "True")
      ...
      (options (list
          ...
          (name "outgoing")
          (comment "The callable implementing delivery to the outgoing mail transport agent.
...
")
          ...
          (name "smtp_host")
          (comment "How to connect to the outgoing MTA.  If smtp_user and smtp_pass is given,
...
")
          ...
          (name "lmtp_host")
          (comment "Where the LMTP server listens for connections.  Use 127.0.0.1 instead of
...
")
          ...
          (comment "Where can we find the mail server specific configuration file?  The path can
...
")
      ...
      (comment "The following lines are specific to mailing lists archiving using
...
")
  ...
  (mailman__core_default_configuration (list
      
      (name "mailman")
      (options (list
          
          (name "site_owner")
          (value (jinja "{{ \"root@\" + mailman__domain }}"))))
      ...
      (options (list
          ...
          (name "url_sqlite")
          (value (jinja "{{ ansible_local.mailman.database_url | d() }}"))
          (state (jinja "{{ \"present\"
                   if ((ansible_local.mailman.database_class | d(\"\")).endswith(\"SQLiteDatabase\"))
                   else \"ignore\" }}"))
      ...
      (options (list
          ...
          (name "admin_pass")
          (value (jinja "{{ ansible_local.mailman.webservice_admin_pass | d(\"restpass\") }}"))))))
  (mailman__core_configuration (list))
  (mailman__core_group_configuration (list))
  (mailman__core_host_configuration (list))
  (mailman__core_combined_configuration (jinja "{{ mailman__core_original_configuration
