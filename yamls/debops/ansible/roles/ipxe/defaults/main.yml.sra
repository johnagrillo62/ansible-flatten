(playbook "debops/ansible/roles/ipxe/defaults/main.yml"
  (ipxe__base_packages (list
      "ipxe"
      "pax"
      "cpio"
      "syslinux-common"
      ...
      "ca-certificates"))
  (ipxe__packages (list))
  (ipxe__tftp_root (jinja "{{ ansible_local.tftpd.directory | d(ansible_local.dnsmasq.boot_tftp_root | d(\"/srv/tftp\")) }}"))
  (ipxe__bootloaders (list
      "/usr/lib/syslinux/memdisk"
      "/usr/lib/ipxe/undionly.kpxe"
      "/boot/ipxe.efi"))
  (ipxe__debian_netboot_enabled "True")
  (ipxe__debian_netboot_firmware (jinja "{{ ansible_local.apt.nonfree | d() | bool }}"))
  (ipxe__debian_netboot_src (jinja "{{ (ansible_local.fhs.src | d(\"/usr/local/src\"))
                              + \"/ipxe/debian/netboot\" }}"))
  (ipxe__debian_netboot_pxe_root (jinja "{{ ipxe__tftp_root + \"/pxe/linux/debian\" }}"))
  ...
  (ipxe__debian_netboot_releases (list
      "bullseye"
      "bookworm"
      "trixie"))
  (ipxe__debian_netboot_architectures (list
      "amd64"
      "i386"
      "arm64"))
  (ipxe__debian_netboot_default_release_map (list
      
      (name "bullseye-amd64")
      (release "bullseye")
      (architecture "amd64")
      (netboot_version "20210731+deb11u12")
      (netboot_checksum "sha256:77033ca69a43f0dd06d274f90f40dcf3487e93772c3331d22ad84419305da157")
      (firmware_version "20240831")
      (firmware_checksum "sha256:5dff544bad3dc197a8e20b6121ef0c005d2f06085b83e7f24ca9feb7e77e42d2")
      ...
      (netboot_subdir "/gtk")
      (netboot_version "20210731+deb11u12")
      (netboot_checksum "sha256:854d108e35b3d96a71cfb5ddcb96fed14e51915aae9c9fdbaa634d1ad17bafa6")
      (firmware_version "20240831")
      (firmware_checksum "sha256:5dff544bad3dc197a8e20b6121ef0c005d2f06085b83e7f24ca9feb7e77e42d2")
      ...
      (netboot_checksum "sha256:2cc3a5c20f9605ac29ea3afb6376d55b14d827f1ac44c42c3d3eed464a3c255b")
      (firmware_version "20250906")
      (firmware_checksum "sha256:09a174c10ea816f1ea704be84005cc7af0a68c2121c282e7d8c89b73b355c36e")
      ...
      (netboot_subdir "/gtk")
      (netboot_version "20230607+deb12u12")
      (netboot_checksum "sha256:130fd44c343e0fe5addbd0afcfc86b2fd3d5f8d77159f238609a6ab3f75ca07e")
      (firmware_version "20250906")
      (firmware_checksum "sha256:09a174c10ea816f1ea704be84005cc7af0a68c2121c282e7d8c89b73b355c36e")
      ...
      (netboot_checksum "sha256:a75870b27965ef67f13a2cdc9d4c574224e16b9b2764f88bf0ecc7c28b244fcb")
      (firmware_version "20250906")
      (firmware_checksum "sha256:e00d0f1c498932e0b8e86663701a96a9d3ad30c0f9200e21427b8db7ce2c900a")
      ...
      (netboot_subdir "/gtk")
      (netboot_version "20250803+deb13u1")
      (netboot_checksum "sha256:ac444dfe9f4e6d62aa54e8d33eae9c30984fb73ee78a15d115273c39026a08eb")
      (firmware_version "20250906")
      (firmware_checksum "sha256:e00d0f1c498932e0b8e86663701a96a9d3ad30c0f9200e21427b8db7ce2c900a")))
  (ipxe__debian_netboot_release_map (list))
  (ipxe__debian_netboot_combined_release_map (jinja "{{ ipxe__debian_netboot_default_release_map
                                               + ipxe__debian_netboot_release_map }}"))
  (ipxe__default_scripts (list
      ...
      (options (list
          ...
          (value (jinja "{{ ansible_local.machine.organization | d(\"DebOps\") + \" Boot Menu\" }}"))
      ...
      (name "boot.ipxe")
      (raw "# iPXE configuration based on https://gist.github.com/robinsmidsrod/2234639
...
")
          ...
          (name "main-menu")
          (raw "item --key d debian-installer ${space} Install Debian GNU/Linux on this host [d]
item
")
          
          (name "main-menu-footer")
          (raw "item netboot_xyz_boot_menu ${space} -> Netboot.xyz Boot Menu
...
")))
      ...
      (raw "chain --autofree variables.ipxe ||
...
")
      (state "present")))
  (ipxe__scripts (list))
  (ipxe__group_scripts (list))
  (ipxe__host_scripts (list))
  (ipxe__combined_scripts (jinja "{{ ipxe__default_scripts
                            + ipxe__scripts
                            + ipxe__group_scripts
                            + ipxe__host_scripts }}")))
