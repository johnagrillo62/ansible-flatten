(playbook "kubespray/roles/kubernetes-apps/csi_driver/vsphere/defaults/main.yml"
  ...
  (csi_endpoint (jinja "{% if external_vsphere_version >= \"7.0u1\" %}") "/csi" (jinja "{% else %}") "/var/lib/csi/sockets/pluginproxy" (jinja "{% endif %}"))
