(playbook "sensu-ansible/defaults/main.yml"
  (se_enterprise "false")
  (se_user "")
  (se_pass "")
  (sensu_package "sensu")
  ...
  (sensu_apt_repo_url "deb     https://eol-repositories.sensuapp.org/apt " (jinja "{{ ansible_distribution_release }}") " main")
  (sensu_apt_key_url "https://eol-repositories.sensuapp.org/apt/pubkey.gpg")
  (sensu_freebsd_url "https://eol-repositories.sensuapp.org/freebsd/FreeBSD:" (jinja "{{ ansible_distribution_major_version }}") ":" (jinja "{{ ansible_architecture }}") "/")
  ...
  (sensu_rabbitmq_host (jinja "{{ groups['sensu_rabbitmq_servers'][0] }}"))
  ...
  (sensu_redis_host (jinja "{{ groups['sensu_redis_servers'][0] }}"))
  (sensu_redis_server "false")
  (sensu_redis_service_name "redis")
  (sensu_redis_pkg_repo null)
  (sensu_redis_pkg_name "redis")
  (sensu_redis_pkg_state "present")
  (sensu_redis_port "6379")
  (sensu_redis_password null)
  (sensu_redis_sentinels (list))
  (sensu_redis_master_name null)
  (sensu_redis_config "sensu-redis.json.j2")
  (sensu_api_host (jinja "{{ groups['sensu_masters'][0] }}"))
  (sensu_api_port "4567")
  (sensu_api_ssl "false")
  ...
  (sensu_client_name (jinja "{{ ansible_hostname }}"))
  (sensu_client_subscriptions (jinja "{{ group_names }}"))
  (sensu_client_keepalive_handlers (list
      "default"))
  ...
  (sensu_master_config_path (jinja "{{ hostvars[groups['sensu_masters'][0]]['sensu_config_path'] | default('/etc/sensu') }}"))
  (sensu_ssl_tool_base_path (jinja "{{ dynamic_data_store }}") "/" (jinja "{{ groups['sensu_masters'][0] }}") (jinja "{{ sensu_master_config_path }}") "/ssl_generation/sensu_ssl_tool")
  (sensu_ssl_client_cert (jinja "{{ sensu_ssl_tool_base_path }}") "/client/cert.pem")
  (sensu_ssl_client_key (jinja "{{ sensu_ssl_tool_base_path }}") "/client/key.pem")
  (sensu_ssl_server_cacert (jinja "{{ sensu_ssl_tool_base_path }}") "/sensu_ca/cacert.pem")
  (sensu_ssl_server_cert (jinja "{{ sensu_ssl_tool_base_path }}") "/server/cert.pem")
  (sensu_ssl_server_key (jinja "{{ sensu_ssl_tool_base_path }}") "/server/key.pem")
  (dynamic_data_store (jinja "{{ playbook_dir }}") "/data/store")
  (static_data_store (jinja "{{ playbook_dir }}") "/data/static")
  (sensu_uchiwa_dc_name null)
  (sensu_uchiwa_path "/opt/uchiwa")
  (sensu_uchiwa_redis_use_ssl "false")
  (sensu_uchiwa_users (list
      
      (username "admin")
      (password "admin")))
  (sensu_uchiwa_port "3000")
  (sensu_uchiwa_refresh "5")
  (sensu_uchiwa_api_port (jinja "{{ sensu_api_port }}"))
  (sensu_uchiwa_auth_privatekey null)
  (sensu_uchiwa_auth_publickey null)
