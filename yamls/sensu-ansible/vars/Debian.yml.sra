(playbook "sensu-ansible/vars/Debian.yml"
  ...
  (sensu_rabbitmq_erlang_repo "deb https://packages.erlang-solutions.com/debian " (jinja "{{ ansible_distribution_release }}") " contrib"))
