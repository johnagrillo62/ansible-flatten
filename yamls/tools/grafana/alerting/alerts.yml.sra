(playbook "tools/grafana/alerting/alerts.yml"
  (apiVersion "1")
  (groups (list
      ...
      (rules (list
          ...
          (data (list
              ...
              (model 
                (editorMode "code")
                (expr "max(delta(awx_instance_status_total{instance=\"awx1:8013\", status=~\"failed|error\"}[30m]))")
                (hide "false")
                (intervalMs "1000")
                (legendFormat "__auto")
                (maxDataPoints "43200")
              ...
              (model 
                (datasource 
                  ...
                  (uid "awx_prometheus"))
                (editorMode "code")
                (expr "max(delta(awx_instance_status_total{instance=\"awx1:8013\", status=\"successful\"}[30m]))")
                (hide "false")
                (intervalMs "1000")
                (legendFormat "__auto")
                (maxDataPoints "43200")
          ...
          (data (list
              ...
              (model 
                ...
                (datasource 
                  ...
                  (type "__expr__")
                  (uid "__expr__"))
                (expression "($10_percent_total_capacity > $last_remaining_capacity) && $last_pending_jobs > 1")
                (hide "false")
                (intervalMs "1000")
                (maxDataPoints "43200")
                (reducer "mean")
